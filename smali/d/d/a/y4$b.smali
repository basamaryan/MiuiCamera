...
.field public final synthetic i:Ld/d/a/y4;
...
.method public constructor <init>(Ld/d/a/y4;)V
    ...
    .line 1
    iput-object p1, p0, Ld/d/a/y4$b;->i:Ld/d/a/y4;
    ...
    iput-object p1, p0, Ld/d/a/y4$b;->a:Ljava/util/List;
    ...
    iput-object p1, p0, Ld/d/a/y4$b;->g:Ljava/lang/Object;
    ...
    .line 5
    invoke-virtual {p0}, Ld/d/a/y4$b;->R()V

    .line 6
    invoke-static {}, Ld/d/a/y4;->l()Lcom/xiaomi/camera/imagecodec/Reprocessor;
    ...
    invoke-direct {v0, p0}, Ld/d/a/s1;-><init>(Ld/d/a/y4$b;)V
    ...
    .line 9
    :cond_0
    invoke-direct {p0}, Ld/d/a/y4$b;->o()V
...
.method private A(Ld/o/f/i/e0;)V
    ...
    .line 3
    iget-object v0, p0, Ld/d/a/y4$b;->a:Ljava/util/List;
...
.method private E()V
    ...
    .line 1
    invoke-direct {p0}, Ld/d/a/y4$b;->n()Ljava/util/Iterator;
...
.method public static synthetic a(Ld/d/a/y4$b;Ld/o/f/i/e0;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Ld/d/a/y4$b;->A(Ld/o/f/i/e0;)V

    return-void
.end method

.method public static synthetic b(Ld/d/a/y4$b;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Ld/d/a/y4$b;->E()V

    return-void
.end method

.method public static synthetic c(Ld/d/a/y4$b;J)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2}, Ld/d/a/y4$b;->F(J)V
...
.method private d()V
    ...
    .line 1
    iget-object v0, p0, Ld/d/a/y4$b;->g:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, Ld/d/a/y4$b;->h:Z
    ...
    .line 4
    :try_start_1
    iget-object v1, p0, Ld/d/a/y4$b;->g:Ljava/lang/Object;
...
.method private i()Ld/o/f/i/e0;
    ...
    .line 2
    :try_start_0
    iget-object v0, p0, Ld/d/a/y4$b;->e:Ld/o/f/i/e0;
...
.method private l(I)Ljava/util/List;
    ...
    .line 3
    :try_start_0
    iget-object v1, p0, Ld/d/a/y4$b;->a:Ljava/util/List;
...
.method private o()V
    ...
    invoke-virtual {v1, v2}, Ld/d/a/h7/n;->T(Ljava/lang/String;)V
    ...
    .line 6
    iput-boolean v1, p0, Ld/d/a/y4$b;->h:Z

    .line 7
    iget-object p0, p0, Ld/d/a/y4$b;->g:Ljava/lang/Object;
...
.method private p()Ld/o/f/i/e0;
    ...
    iget-object v2, p0, Ld/d/a/y4$b;->i:Ld/d/a/y4;

    .line 2
    invoke-static {v2}, Ld/d/a/y4;->h(Ld/d/a/y4;)Ld/o/f/i/e0$j;
    ...
    .line 3
    iget-object v1, p0, Ld/d/a/y4$b;->i:Ld/d/a/y4;

    invoke-static {v1}, Ld/d/a/y4;->d(Ld/d/a/y4;)I
    ...
    invoke-static {v1}, Ld/d/a/y4;->f(Ld/d/a/y4;)Z
    ...
    invoke-static {v2}, Ld/d/a/y4;->d(Ld/d/a/y4;)I
    ...
    iget-object p0, p0, Ld/d/a/y4$b;->i:Ld/d/a/y4;

    .line 6
    invoke-static {p0}, Ld/d/a/y4;->f(Ld/d/a/y4;)Z
...
.method public static synthetic u(Ld/d/a/y4$b;)V
    .locals 0
...
.method public B(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    .line 1
    invoke-direct {p0}, Ld/d/a/y4$b;->i()Ld/o/f/i/e0;
...
.method public D()V
    ...
    .line 5
    iput-boolean v2, p0, Ld/d/a/y4$b;->h:Z
...
.method public J(Ld/d/a/w7/p;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Ld/o/f/i/e0;->Q0(Ld/d/a/w7/p;)V
...
.method public K(Ld/d/a/y4$c;)V
    ...
    invoke-static {p0, v0}, Ld/d/a/y4;->b(Ld/d/a/y4;Ljava/lang/ref/WeakReference;)Ljava/lang/ref/WeakReference;
...
.method public O(Z)V
    ...
    .line 1
    iget-object v0, p0, Ld/d/a/y4$b;->i:Ld/d/a/y4;

    invoke-static {v0, p1}, Ld/d/a/y4;->g(Ld/d/a/y4;Z)Z
...
.method public Q(I)V
    ...
    .line 2
    invoke-direct {p0, p1}, Ld/d/a/y4$b;->m(I)Ljava/util/List;
...
.method public R()V
    ...
    .line 4
    invoke-virtual {p0, v0, v1}, Ld/d/a/y4$b;->S(Ljava/lang/String;Ljava/lang/String;)V
...
.method public e(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    .line 2
    invoke-direct {p0}, Ld/d/a/y4$b;->d()V
    ...
    .line 4
    :try_start_0
    iget-object v0, p0, Ld/d/a/y4$b;->f:Landroid/util/SparseArray;

    invoke-direct {p0, p1, v0}, Ld/d/a/y4$b;->t(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    iget-object v3, p0, Ld/d/a/y4$b;->e:Ld/o/f/i/e0;
    ...
    .line 7
    iget-object p1, p0, Ld/d/a/y4$b;->e:Ld/o/f/i/e0;
    ...
    iget-object v4, p0, Ld/d/a/y4$b;->a:Ljava/util/List;
    ...
    .line 11
    :goto_0
    iget-object v3, p0, Ld/d/a/y4$b;->a:Ljava/util/List;
    ...
    .line 15
    invoke-direct {p0, p1, v4}, Ld/d/a/y4$b;->t(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    .line 21
    :cond_2
    iput-object p1, p0, Ld/d/a/y4$b;->f:Landroid/util/SparseArray;

    .line 22
    iput-object v3, p0, Ld/d/a/y4$b;->e:Ld/o/f/i/e0;
    ...
    .line 24
    invoke-direct {p0}, Ld/d/a/y4$b;->p()Ld/o/f/i/e0;
    ...
    .line 27
    iget-object p2, p0, Ld/d/a/y4$b;->a:Ljava/util/List;
    ...
    .line 29
    iget-object p2, p0, Ld/d/a/y4$b;->e:Ld/o/f/i/e0;
    ...
    .line 31
    iput-object v1, p0, Ld/d/a/y4$b;->e:Ld/o/f/i/e0;
...
.method public g(I)V
    ...
    invoke-static {v0, p1}, Ld/d/a/y4;->e(Ld/d/a/y4;I)I
    ...
    invoke-static {p0}, Ld/d/a/y4;->d(Ld/d/a/y4;)I
...
.method public w(I)V
    ...
    .line 2
    invoke-direct {p0, p1}, Ld/d/a/y4$b;->l(I)Ljava/util/List;
