.class public Ld/d/a/u6/i4/i/s1;
...
.method public static a(Landroid/content/Context;IZ)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 1
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->g(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 2
    :pswitch_0
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->f(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 3
    :pswitch_1
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->d(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 4
    :pswitch_2
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->b(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 5
    :pswitch_3
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->c(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 6
    :pswitch_4
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->h(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 7
    :pswitch_5
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->i(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
    ...
    .line 8
    :pswitch_6
    invoke-static {p0, p2}, Ld/d/a/u6/i4/i/s1;->e(Landroid/content/Context;Z)Landroid/widget/FrameLayout$LayoutParams;
