...
.method public static synthetic b(Lcom/android/camera/ThumbnailUpdater;Ld/d/a/w5;ZZZ)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/camera/ThumbnailUpdater;->v(Ld/d/a/w5;ZZZ)V
...
.method private static g(Z)Landroid/net/Uri;
    ...
    invoke-static {v3}, Ld/d/a/a7/a/b/a;->k(Landroid/content/Context;)Ljava/lang/String;
...
.method private synthetic q(ZIZ)V
    ...
    .line 3
    :cond_0
    invoke-interface {v0}, Ld/d/a/m7/g/h;->canProvide()Z
    ...
    .line 5
    :cond_1
    iget-object p0, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/d/a/w5;

    invoke-interface {v0, p0, p1, p2, p3}, Ld/d/a/m7/g/h;->P2(Ld/d/a/w5;ZIZ)V
...
.method private v(Ld/d/a/w5;ZZZ)V
    .locals 0
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1
    iput-object p1, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/d/a/w5;
...
.method public h()V
    ...
    iget-object v5, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/d/a/w5;

    invoke-direct {v1, v3, v4, p0, v5}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Ld/d/a/w5;)V
...
.method public i(Z)V
    ...
    iget-object v8, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/d/a/w5;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/android/camera/ThumbnailUpdater$LoadThumbnailTask;-><init>(ZZLjava/lang/ref/Reference;Lcom/android/camera/ThumbnailUpdater;Ld/d/a/w5;)V
...
.method public t()V
    ...
    .line 3
    :cond_0
    iget-object v2, p0, Lcom/android/camera/ThumbnailUpdater;->b:Ld/d/a/w5;

    if-eqz v2, :cond_1

    invoke-virtual {v2}, Ld/d/a/w5;->m()Z
...
.method public u(Ld/d/a/w5;ZZ)V
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/android/camera/ThumbnailUpdater;->v(Ld/d/a/w5;ZZZ)V
...
.method public x()V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/camera/ThumbnailUpdater$a;-><init>(Landroid/os/Handler;Ld/d/a/y5;)V
    ...
    invoke-direct {v0, v1, p0}, Lcom/android/camera/ThumbnailUpdater$b;-><init>(Landroid/os/Handler;Ld/d/a/y5;)V
