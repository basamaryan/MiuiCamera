...
.method public constructor <init>(Lcom/android/camera/Camera;Landroid/view/View;)V
    ...
    invoke-direct {v0, p1, v1, v2, v3}, Ld/d/a/b7/d1;-><init>(Landroid/content/Context;Landroid/view/SurfaceView;Landroid/widget/Button;Landroid/widget/ImageView;)V

    iput-object v0, p0, Lcom/android/camera/litegallery/RecyclerVideoItemHolder;->s:Ld/d/a/b7/d1;
...
.method public a()V
    ...
    .line 2
    iget-object v0, p0, Lcom/android/camera/litegallery/RecyclerVideoItemHolder;->s:Ld/d/a/b7/d1;

    if-eqz v0, :cond_0

    .line 3
    invoke-virtual {v0}, Ld/d/a/b7/d1;->release()V

    .line 4
    iget-object p0, p0, Lcom/android/camera/litegallery/RecyclerVideoItemHolder;->s:Ld/d/a/b7/d1;
...
.method public g(Ld/d/a/b7/f1;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lcom/android/camera/litegallery/RecyclerBaseItemHolder;->g(Ld/d/a/b7/f1;)V

    .line 2
    iget-object v0, p0, Lcom/android/camera/litegallery/RecyclerVideoItemHolder;->s:Ld/d/a/b7/d1;

    invoke-virtual {v0, p1}, Ld/d/a/b7/d1;->s(Ld/d/a/b7/f1;)V

    .line 3
    iget-object p0, p0, Lcom/android/camera/litegallery/RecyclerVideoItemHolder;->p:Landroid/widget/ImageView;

    invoke-static {p1, p0}, Ld/d/a/b7/j1;->G(Ld/d/a/b7/f1;Landroid/widget/ImageView;)V
...
.method public h(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0}, Ld/d/a/b7/d1;->a()V
